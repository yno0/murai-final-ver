    ...
    <div className="space-y-6">
      <div className="border-b border-gray-200 pb-4">
        ...
        <p className="text-gray-600 mt-1">
          Manage end users who have the MURAi extension installed
        </p>
      </div>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-red-600">{stats.byStatus?.suspended || 0}</p>
            </div>
      ...
      <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center gap-2 px-4 py-2 bg-[#015763] text-white rounded-lg hover:bg-[#014a54] disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              {searchTerm || statusFilter ? 'Try adjusting your search or filter criteria.' : 'No users have been registered yet.'}
            </p>
          </div>
        ) : (
          <>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 py-4 space-y-6">
              <div className="flex items-center gap-4">
                <div className="h-16 w-16 rounded-full bg-[#015763] flex items-center justify-center">
